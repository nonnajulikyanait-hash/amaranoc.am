...
export default function Nkar27() {
  const [currency, setCurrency] = useState('AMD');

  // Արժույթների փոխարժեքներ
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-3 rounded-3xl overflow-hidden mb-8 h-[500px]">
          <div className="md:col-span-6 h-full">
            <img src="https://amaranoc.am/_next/image?url=https%3A%2F%2Fapi.amaranoc.am%2F1781177674279--0.8138218491013156image_optimized.webp&w=3840&q=75" className="w-full h-full object-cover" alt="Villa" />
          </div>
          <div className="md:col-span-6 grid grid-cols-2 gap-3 h-full">
            <img src="https://amaranoc.am/_next/image?url=https%3A%2F%2Fapi.amaranoc.am%2F1781177674289--0.5488183068901058image_optimized.webp&w=3840&q=75" className="w-full h-full object-cover" alt="P1" />
            <img src="https://amaranoc.am/_next/image?url=https%3A%2F%2Fapi.amaranoc.am%2F1781177674295--0.04594187062148447image_optimized.webp&w=3840&q=75" className="w-full h-full object-cover" alt="P2" />
            <img src="https://amaranoc.am/_next/image?url=https%3A%2F%2Fapi.amaranoc.am%2F1781177674298--0.519750238722922image_optimized.webp&w=3840&q=75" className="w-full h-full object-cover" alt="P3" />
            <img src="https://amaranoc.am/_next/image?url=https%3A%2F%2Fapi.amaranoc.am%2F1781177674311--0.8918248910966271image_optimized.webp&w=3840&q=75" className="w-full h-full object-cover" alt="P4" />
          </div>
        </div>
