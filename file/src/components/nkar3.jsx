...
export default function Nkar3() {
  // Ստեղծում ենք վիճակ՝ ընտրված արժույթի ID-ն պահելու համար (0 = AMD, 1 = USD, 2 = EUR, 3 = RUB)
  const [selectedCurrencyId, setSelectedCurrencyId] = useState(0);

  // Արժույթների զանգվածը և փոխարժեքները
  const currencies = [
  ...
  // Սկզբնական գները (AMD-ով)` ըստ Nkar3-ի տվյալների
  const basePrice = 120000;
  const basePriceOvernight = 150000;

  // Հաշվարկում ենք դինամիկ գները՝ ըստ ընտրված արժույթի
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-3 rounded-3xl overflow-hidden mb-8 relative">
          ...
          <div className="md:col-span-6 h-[300px] md:h-[500px] relative group">
            <img 
              src="https://amaranoc.am/_next/image?url=https%3A%2F%2Fapi.amaranoc.am%2F1769679162021--0.866301303457238image_optimized.webp&w=3840&q=75" 
              alt="Pool Large" 
          ...
          <div className="md:col-span-6 grid grid-cols-2 gap-3 h-[300px] md:h-[500px] relative">
            <img src="https://amaranoc.am/_next/image?url=https%3A%2F%2Fapi.amaranoc.am%2F1769436022134--0.560895395077905image_optimized.webp&w=3840&q=75" alt="Pool 1" className="w-full h-full object-cover" />
            <img src="https://amaranoc.am/_next/image?url=https%3A%2F%2Fapi.amaranoc.am%2F1769436095214--0.49574197711393553image_optimized.webp&w=3840&q=75" alt="Villa Exterior" className="w-full h-full object-cover" />
            <img src="https://amaranoc.am/_next/image?url=https%3A%2F%2Fapi.amaranoc.am%2F1769436168086--0.8106607643658372image_optimized.webp&w=3840&q=75" alt="A-Frame House" className="w-full h-full object-cover" />
            <div className="relative w-full h-full">
              <img src="https://amaranoc.am/_next/image?url=https%3A%2F%2Fapi.amaranoc.am%2F1769436094048--0.6884677725389039image_optimized.webp&w=3840&q=75" alt="Pool Interior" className="w-full h-full object-cover" />
        ...
        <div className="w-full h-[350px] md:h-[450px] rounded-3xl overflow-hidden relative shadow-inner mb-12 border border-gray-200">
          ...
          {/* Քարտեզի վրայի գնային պիտակները */}
