...
export default function Nkar20() {
  const [currency, setCurrency] = useState('AMD');

  // Հայտարարության տվյալների բազա (image_f9488c.jpg)
  const details = [
  ...
  // Առավելությունների ցանկ (image_f9482c.jpg)
  const amenities = [
  ...
  return (
    <div className="w-full bg-white font-sans pb-32 relative">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between border border-gray-200 rounded-2xl p-4 mb-6 gap-4 shadow-sm">
          <div className="flex items-center gap-4">
            <div className="flex items-center gap-2 text-xl font-black text-gray-900">
              <span className="text-orange-500 text-2xl">📍</span> Պտղնի
            </div>
          ...
          <div className="flex flex-wrap items-center gap-6 md:gap-8">
            <div>
              ...
              <span className="text-2xl font-black text-orange-500">100,000</span>
            </div>
            ...
            <div className="flex bg-gray-100 p-1 rounded-full border border-gray-200">
              {['֏', '$', '€', '₽'].map((symbol, idx) => (
                <button 
                  key={idx}
                  onClick={() => setCurrency(idx === 0 ? 'AMD' : idx === 1 ? 'USD' : idx === 2 ? 'EUR' : 'RUB')}
                  className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold transition-all ${idx === 0 ? 'bg-[#0f172a] text-white' : 'text-gray-600 hover:bg-gray-200'}`}
                >
                  {symbol}
                </button>
              ))}
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-3 rounded-3xl overflow-hidden mb-8 relative">
          ...
          <div className="md:col-span-6 h-[300px] md:h-[500px] relative group">
            <img 
              src="https://amaranoc.am/_next/image?url=https%3A%2F%2Fapi.amaranoc.am%2F1781359193254--0.6837872652089114image_optimized.webp&w=3840&q=75" 
              alt="Pool Large" 
              className="w-full h-full object-cover"
            />
            <button className="absolute bottom-4 right-4 bg-white/80 backdrop-blur-sm p-2.5 rounded-full hover:bg-white shadow-md transition">
              ❤️
            </button>
          </div>
          ...
          <div className="md:col-span-6 grid grid-cols-2 gap-3 h-[300px] md:h-[500px] relative">
            <img src="https://amaranoc.am/_next/image?url=https%3A%2F%2Fapi.amaranoc.am%2F1781359193259--0.06534245745171763image_optimized.webp&w=3840&q=75" alt="Pool 1" className="w-full h-full object-cover" />
            <img src="https://amaranoc.am/_next/image?url=https%3A%2F%2Fapi.amaranoc.am%2F1781359193261--0.5021884735794337image_optimized.webp&w=3840&q=75" alt="Villa Exterior" className="w-full h-full object-cover" />
            <img src="https://amaranoc.am/_next/image?url=https%3A%2F%2Fapi.amaranoc.am%2F1781359193263--0.007490822054989188image_optimized.webp&w=3840&q=75" alt="A-Frame House" className="w-full h-full object-cover" />
            <div className="relative w-full h-full">
              <img src="https://amaranoc.am/_next/image?url=https%3A%2F%2Fapi.amaranoc.am%2F1781359193264--0.12443084956513539image_optimized.webp&w=3840&q=75" alt="Pool Interior" className="w-full h-full object-cover" />
              {/* Տեսնել բոլորը կոճակ */}
              <button className="absolute bottom-4 right-4 bg-white hover:bg-gray-100 text-gray-900 font-bold text-xs px-4 py-2 rounded-lg shadow-md transition">
                Տեսնել բոլորը
              </button>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start mb-12">
          ...
          <div className="lg:col-span-6 border border-gray-200 rounded-3xl overflow-hidden shadow-sm bg-white">
            ...
            <div className="grid grid-cols-7 text-center p-3 gap-y-3 text-xs font-semibold text-gray-400">
              ...
              <div className="py-1 text-gray-300 font-light2">2</div>
        ...
        <div className="w-full bg-white py-8 border-t border-gray-100">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-start gap-6 mt-6 pl-2">
            <button className="px-8 py-3 bg-[#f59e0b] hover:bg-orange-500 text-white font-bold text-sm rounded-full shadow-sm transition">
              Թողնել կարծիք
            </button>
            <button className="text-gray-900 hover:text-gray-600 font-bold text-sm transition">
              Տեսնել բոլորը
            </button>
          </div>
        </div>
      ...
      <div className="fixed bottom-6 left-1/2 transform -translate-x-1/2 z-50 bg-[#475569]/90 backdrop-blur-md py-3 px-6 rounded-full shadow-2xl border border-white/10 flex items-center gap-6 md:gap-8 max-w-[90vw] sm:max-w-xl">
        <button className="text-white/80 hover:text-white font-bold text-xs whitespace-nowrap transition">Նկարներ</button>
        <button className="text-white/80 hover:text-white font-bold text-xs whitespace-nowrap transition">Հայտարարության մասին</button>
        <button className="text-white/80 hover:text-white font-bold text-xs whitespace-nowrap transition">Քարտեզ</button>
        <button className="text-white/80 hover:text-white font-bold text-xs whitespace-nowrap transition">Կարծիքներ</button>
        <button className="bg-[#f97316] hover:bg-orange-600 text-white font-black text-xs px-6 py-2.5 rounded-full shadow-md transition whitespace-nowrap">
          Ամրագրել
        </button>
      </div>
