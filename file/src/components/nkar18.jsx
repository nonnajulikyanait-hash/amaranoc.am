...
export default function Nkar18() {
  const [currency, setCurrency] = useState('AMD');

  // Բազային արժեքները դրամով (150,000) և մոտարկված փոխարժեքները
  const basePriceDay = 150000;
  const basePriceNight = 150000;
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-3 rounded-3xl overflow-hidden mb-8 relative">
          ...
          <div className="md:col-span-6 h-[300px] md:h-[500px] relative group">
            <img 
              src="https://amaranoc.am/_next/image?url=https%3A%2F%2Fapi.amaranoc.am%2F1781423943228--0.5873319387805591image_optimized.webp&w=3840&q=75" 
              alt="Pool Large" 
          ...
          <div className="md:col-span-6 grid grid-cols-2 gap-3 h-[300px] md:h-[500px] relative">
            <img src="https://amaranoc.am/_next/image?url=https%3A%2F%2Fapi.amaranoc.am%2F1781423943424--0.8127346033311493image_optimized.webp&w=3840&q=75" alt="Pool 1" className="w-full h-full object-cover" />
            <img src="https://amaranoc.am/_next/image?url=https%3A%2F%2Fapi.amaranoc.am%2F1781423943461--0.17757269404172016image_optimized.webp&w=3840&q=75" alt="Villa Exterior" className="w-full h-full object-cover" />
            <img src="https://amaranoc.am/_next/image?url=https%3A%2F%2Fapi.amaranoc.am%2F1781424165387--0.1387792956873235image_optimized.webp&w=3840&q=75" alt="A-Frame House" className="w-full h-full object-cover" />
            <div className="relative w-full h-full">
              <img src="https://amaranoc.am/_next/image?url=https%3A%2F%2Fapi.amaranoc.am%2F1781423943471--0.45889080956078265image_optimized.webp&w=3840&q=75" alt="Pool Interior" className="w-full h-full object-cover" />
              {/* Տեսնել բոլորը կոճակ */}
