  ...
  return (
    <div className="w-full bg-white font-sans pb-32 relative">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 mobile-tight">
        ...
        {/* --- 6. ԱՎԵԼԱՑՆԵԼ ՀԱՅՏԱՐԱՐՈՒԹՅՈՒՆ (ADD LISTING SECTION) --- */}
        <div className="bg-gradient-to-r from-slate-900 to-slate-800 rounded-3xl p-8 md:p-12 text-white shadow-xl mb-12 flex flex-col md:flex-row items-center justify-between gap-8">
          <div className="max-w-xl">
            <span className="bg-orange-500/20 text-orange-400 font-bold text-xs px-3 py-1 rounded-full uppercase tracking-wider">Գործընկերություն</span>
            <h3 className="text-2xl md:text-3xl font-black mt-3 mb-2">Ունե՞ք ամառանոց կամ առանձնատուն</h3>
            <p className="text-gray-300 text-xs md:text-sm leading-relaxed">
              Ավելացրե՛ք ձեր հայտարարությունը մեր հարթակում, գտե՛ք հաճախորդներ և ստացե՛ք լրացուցիչ եկամուտ առանց դժվարությունների։
            </p>
          </div>
          <button 
            onClick={() => alert('Հայտարարության ավելացման ձևաթուղթը շուտով հասանելի կլինի:')}
            className="bg-[#f97316] hover:bg-orange-600 text-white font-black text-sm px-8 py-4 rounded-2xl shadow-lg transition whitespace-nowrap"
          >
      ...
      {/* --- FOOTER --- */}
      <footer className="bg-slate-900 text-white pt-12 pb-24 border-t border-slate-800 mt-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          <div>
            <h4 className="text-lg font-black tracking-wider text-orange-500 mb-4">AMARANOC.AM</h4>
            <p className="text-gray-400 text-xs leading-relaxed">
              Ձեր վստահելի ուղեկցը Հայաստանի լավագույն ամառանոցների և առանձնատների ամրագրման աշխարհում:
            </p>
          </div>
          <div>
            <h5 className="font-bold text-sm mb-4 text-gray-200">Արագ հղումներ</h5>
            <ul className="space-y-2 text-xs text-gray-400">
              <li><Link to="/" className="hover:text-orange-400 transition">Գլխավոր էջ</Link></li>
              <li><Link to="/" className="hover:text-orange-400 transition">Թեժ առաջարկներ</Link></li>
              <li><Link to="/" className="hover:text-orange-400 transition">Նվեր քարտեր</Link></li>
            </ul>
          </div>
          <div>
            <h5 className="font-bold text-sm mb-4 text-gray-200">Կապ մեզ հետ</h5>
            <ul className="space-y-2 text-xs text-gray-400">
              <li>📞 +374 (00) 00-00-00</li>
              <li>✉️ info@amaranoc.am</li>
              <li>📍 ք. Երևան, Հայաստան</li>
            </ul>
          </div>
          <div>
            <h5 className="font-bold text-sm mb-4 text-gray-200">Բաժանորդագրություն</h5>
            <p className="text-xs text-gray-400 mb-3">Ստացեք նորություններ և բացառիկ զեղչեր առաջինը։</p>
            <div className="flex gap-2">
              <input type="email" placeholder="Էլ. հասցե" className="bg-slate-800 border border-slate-700 px-3 py-2 rounded-xl text-xs w-full outline-none focus:border-orange-500 text-white" />
              <button className="bg-orange-500 hover:bg-orange-600 px-4 py-2 rounded-xl text-xs font-bold transition">➤</button>
            </div>
          </div>
        </div>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 border-t border-slate-800 pt-6 text-center text-xs text-gray-500">
